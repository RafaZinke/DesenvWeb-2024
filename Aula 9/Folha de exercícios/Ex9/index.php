...
<head>
    ...
    <title>Simulação de Parcelamento: Juquinha (Juros Compostos)</title>
</head>
<body>

    <h1>Simulação de Parcelamento da Moto - Juros Compostos</h1>
    ...
    <table border="1" cellpadding="10">
        ...
        <tbody>
            ...
            foreach ($opcoesParcelas as $numParcelas) {
                $taxaJuros = exibirTaxaJurosCompostos($numParcelas);

                $valorParcela = calcularParcelasCompostas($valorMoto, $taxaJuros, $numParcelas);
